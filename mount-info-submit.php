...
$sql = "insert into mount_info(`source`,`destination`,`start_date`,`number_of_people`,`contact_phone`,`postscript`,`unit_cert`)"
  ." values(?,?,?,?,?,?,?)";

if( $stmt = $mysqli->prepare($sql) ){

  $stmt->bind_param("sssisss", $source, $destination, $startDate, $numberOfPeople, $contactPhone, $postscript, $unit_cert);
...
<meta charset="UTF-8">
  ...
  <a href="./" class="ui-btn ui-btn-inline">返回</a>
  <a href="#" class="ui-btn ui-btn-inline">查看</a>
